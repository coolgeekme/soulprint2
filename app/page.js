      ...
      <section className="bg-white py-20 px-8 border-t border-gray-200">
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-10">
            ...
            <h2 className="font-condensed font-black text-gray-900 text-3xl md:text-4xl uppercase tracking-wide">
              Native Language Versions
            </h2>
            <p className="text-gray-700 text-sm mt-3 max-w-lg mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-5">
            {/* Spanish */}
            <div className="relative group bg-gradient-to-br from-red-50 via-orange-50 to-red-50 border-2 border-red-200 rounded-2xl p-6 hover:border-red-300 transition-all overflow-hidden">
              <div className="absolute top-0 right-0 w-32 h-32 bg-gradient-to-bl from-red-100 to-transparent rounded-bl-full opacity-50" />
              <div className="relative z-10">
                <div className="flex items-center gap-3 mb-3">
                  <span className="text-3xl">🇪🇸</span>
                  <div>
                    <h3 className="text-gray-900 font-bold text-lg">Español</h3>
                    <p className="text-red-700 text-xs font-medium">Versión Nativa en Español</p>
                  </div>
                </div>
                <p className="text-gray-800 text-sm mb-5 font-medium">
                ...
                <div className="flex items-center gap-3">
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="inline-flex items-center gap-2 px-4 py-2.5 bg-red-600 hover:bg-red-700 text-white text-xs font-bold rounded-lg transition-colors shadow-md"
                  >
                    Únete a la Lista de Espera
                    <ArrowRight className="w-3.5 h-3.5" />
                  </a>
                  <span className="px-2.5 py-1 bg-green-100 border border-green-300 rounded-full text-green-700 text-[10px] font-semibold uppercase tracking-wider">
                    Launching Soon
                  </span>
                </div>
              </div>
            ...
            {/* Portuguese */}
            <div className="relative group bg-gradient-to-br from-green-50 via-teal-50 to-green-50 border-2 border-green-200 rounded-2xl p-6 hover:border-green-300 transition-all overflow-hidden">
              ...
              <div className="relative z-10">
                <div className="flex items-center gap-3 mb-3">
                  <span className="text-3xl">🇧🇷</span>
                  <div>
                    <h3 className="text-gray-900 font-bold text-lg">Português</h3>
                    <p className="text-green-700 text-xs font-medium">Versão Nativa em Português</p>
                  </div>
                </div>
                <p className="text-gray-800 text-sm mb-5 font-medium">
                ...
                <div className="flex items-center gap-3">
                  <span className="inline-flex items-center gap-2 px-4 py-2.5 bg-gray-200 border border-gray-300 text-gray-700 text-xs font-bold rounded-lg">
                    🔔 Coming Soon
                  </span>
                  <span className="px-2.5 py-1 bg-yellow-100 border border-yellow-300 rounded-full text-yellow-700 text-[10px] font-semibold uppercase tracking-wider">
                    In Development
                  </span>
                </div>
              </div>
