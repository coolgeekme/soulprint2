...
export async function POST(request) {
  ...
  // Claude (DCR) authenticates with client_secret_post — secret in the body, or
  // HTTP Basic as a fallback. ChatGPT's CIMD client_id is a URL and resolves to
  // null, so the CIMD flow skips this check entirely.
