...
agent_communication:
  ...
  - agent: "main"
    message: "Built complete SoulPrint Engine MVP. All routes implemented. Testing critical backend flows: auth, assessment, chat streaming, admin. Base URL is https://smart-gen-6.preview.emergentagent.com. Test with fresh user registration first."
  - agent: "testing"
