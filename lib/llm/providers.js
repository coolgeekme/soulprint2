...
export const WEB_SEARCH_TOOL = {
  ...
  function: {
    name: 'search_web',
    description: 'Search the internet for real-time, up-to-date information. YOU MUST USE THIS TOOL when the user asks about: weather, news, current events, sports scores, stock prices, recent happenings, "what is X", "who is X", "tell me about X", or any question that requires information beyond your training data. ALWAYS search before answering questions about current/recent events.',
    parameters: {
      type: 'object',
      properties: {
        query: { type: 'string', description: 'Specific search query. Be detailed and include relevant context.' },
        search_depth: { type: 'string', enum: ['basic', 'advanced'], description: 'Use advanced for complex research queries' },
      },
      required: ['query'],
    },
  },
