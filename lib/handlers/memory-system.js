...
function classifyMemory(content) {
  const c = content.toLowerCase();
  const rules = [
    ['health', /\b(allerg|medication|condition|diagnos|surgery|therapy|doctor|prescri|blood|heart|diabet|asthma|mental|anxiety|depression|pain|injury|pregnan)\b/i],
    ['relationships', /\b(wife|husband|spouse|partner|girlfriend|boyfriend|fianc|married|daughter|son|child|kid|mother|father|mom|dad|sister|brother|parent|family|friend|cousin|aunt|uncle|grandma|grandpa)\b/i],
    ['work', /\b(work|job|career|company|startup|business|cto|ceo|founder|co-founder|employee|employer|boss|manager|client|project|profession|industry|team|salary|promot|hire|quit|laid off)\b/i],
    ['goals', /\b(goal|aspir|dream|plan to|want to|hoping to|working toward|aim|ambition|resolution|target|saving up|saving for)\b/i],
    ['preferences', /\b(prefer|favorite|favourite|love|like|enjoy|hate|dislike|can'?t stand|avoid|fan of|into)\b/i],
  ];
