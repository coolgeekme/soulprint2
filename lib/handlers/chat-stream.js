    ...
    const docStream = new ReadableStream({
      async start(controller) {
        try {
          ...
          let documentContent = '';
          const llmStream = await llmProvider.streamChat([
            { role: 'system', content: 'You are a helpful assistant that generates structured data for documents. Output clean, well-organized data.' },
