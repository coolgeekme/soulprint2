...
async function handleGoogleAuthStart(request) {
  try {
    ...
    // Use NEXT_PUBLIC_BASE_URL from environment (external URL)
    // DO NOT use request.url as it gives internal URL (0.0.0.0:3000)
    const baseUrl = process.env.NEXT_PUBLIC_BASE_URL || 'https://soulprintengine.ai';
